  ...
  head: () => ({
    meta: [
      ...
      { title: "AI Farm Assistant — Smarter Farming, Higher Yield" },
      {
        name: "description",
        content:
          "AI-powered crop yield prediction, soil monitoring, irrigation optimization and farming insights for Indian farmers.",
      },
      { name: "author", content: "AI Farm Assistant" },
      { property: "og:title", content: "AI Farm Assistant" },
      {
        property: "og:description",
        content: "Smarter Farming. Better Decisions. Higher Yield.",
      },
